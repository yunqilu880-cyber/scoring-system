...
const seedStudents = [
  ['stu-1', '张老师', 'JS2026001', '示例单位一', '语文', '中级首聘', 0, 0, 0, 0, 0, false, 0, 'inactive', true],
  ['stu-2', '李老师', 'JS2026002', '示例单位一', '数学', '高级首聘', 0, 0, 0, 0, 0, false, 0, 'active', false],
  ['stu-3', '王老师', 'JS2026003', '示例单位二', '英语', '层级内晋升', 0, 0, 0, 0, 1, false, 0, 'active', false],
  ['stu-4', '陈老师', 'JS2026004', '示例单位三', '道德与法治', '中级首聘', 0, 0, 0, 0, 0, true, 0, 'inactive', true],
  ['stu-5', '刘老师', 'JS2026005', '示例单位一', '体育', '高级首聘', 0, 0, 0, 0, 0, false, 0, 'active', false],
  ['stu-6', '赵老师', 'JS2026006', '示例单位二', '科学', '层级内晋升', 0, 0, 0, 0, 0, false, 0, 'locked', true],
]
